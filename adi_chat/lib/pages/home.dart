...
import 'package:ChataKai/widgets/chat_user_card.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      final time = TimeFormatter.formatEpochToTime(context: context, epoch: now);
      APIs.updateLastSeen(time);
    });
  }
              ...
              FloatingActionButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (_) => KAIChatScreen(user: APIs.me),
                    ),
                  );
                },
